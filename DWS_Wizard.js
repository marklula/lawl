...
function askQuestion() {
    ...
    if (!question) {
      ...
      // COMBINE ALL MICROPHONE RESPONSES INTO SINGLE STORE ENTRY
      let primaryMics = '';
      let secondaryMics = '';
      for (let p = 1; p <= responses[7]; p++)
      {
        if (p == responses[7])
        {
          primaryMics += responses[(7 + p)].toUpperCase();
        }
        else{
          primaryMics += responses[(7 + p)].toUpperCase() + ",";
        }   
      }
      // COLLAPSE RESPONSES TO COMBINE TO SINGLE PREDICTABLE RESPONSE NUMBER
      responses.splice(7,Number(responses[7]) + 1,primaryMics);

      for (let s = 1; s <= responses[8]; s++)
      {
        if (s == responses[8])
        {
          secondaryMics += responses[(8 + s)].toUpperCase();
        }
        else{
          secondaryMics += responses[(8 + s)].toUpperCase() + ",";
        }   
      ...
      let panel = `<Extensions>
                    ...
                    <Page>
                      ...
                      <Row>
                        <Name/>
                        <Widget>
                          <WidgetId>widget_52</WidgetId>
                          <Name>Please validate the configurations on each tab.</Name>
                          <Type>Text</Type>
                      ...
                      <Row>
                        ...
                        <Widget>
                          <WidgetId>dws_config_confirm</WidgetId>
                          <Name>Switch Type: ${responses[0]}</Name>
                          <Type>Text</Type>
                          <Options>size=2;fontSize=small;align=center</Options>
                        </Widget>
                        <Widget>
                          <WidgetId>widget_77</WidgetId>
                          <Name>Automatic Camera Mode Default: ${responses[9]}</Name>
                          <Type>Text</Type>
                          <Options>size=2;fontSize=small;align=center</Options>
                        </Widget>
                        <Widget>
                          <WidgetId>widget_59</WidgetId>
                          <Name>Username: ${responses[1]}</Name>
                          <Type>Text</Type>
                          <Options>size=2;fontSize=small;align=center</Options>
                        </Widget>
                        <Widget>
                          <WidgetId>widget_61</WidgetId>
                          <Name>Password: ${responses[2]}</Name>
                          <Type>Text</Type>
                          <Options>size=2;fontSize=small;align=center</Options>
                        </Widget>
                        <Widget>
                          <WidgetId>widget_80</WidgetId>
                          <Type>Spacer</Type>
                          <Options>size=3</Options>
                        </Widget>
                        <Widget>
                          <WidgetId>dws_wizard_common</WidgetId>
                          <Name>Next</Name>
                          <Type>Button</Type>
                          <Options>size=2</Options>
                        </Widget>
                      </Row>
                      <PageId>dws_wizard_common</PageId>
                    ...
                    <Page>
                      ...
                      <Row>
                        <Name>Row</Name>
                        <Widget>
                          <WidgetId>dws_pri_mics</WidgetId>
                          <Name>Primary Microphones: ${primaryMics}</Name>
                          <Type>Text</Type>
                          <Options>size=4;fontSize=small;align=left</Options>
                        </Widget>
                        <Widget>
                          <WidgetId>dws_sec_host</WidgetId>
                          <Name>Secondary Host: ${responses[3]}</Name>
                          <Type>Text</Type>
                          <Options>size=2;fontSize=small;align=left</Options>
                        </Widget>
                        <Widget>
                          <WidgetId>dws_sec_displays</WidgetId>
                          <Name># of Secondary Displays: ${responses[4]}</Name>
                          <Type>Text</Type>
                          <Options>size=2;fontSize=small;align=left</Options>
                        </Widget>
                        <Widget>
                          <WidgetId>dws_sec_nav</WidgetId>
                          <Name>Secondary Control Nav: ${responses[5]}</Name>
                          <Type>Text</Type>
                          <Options>size=2;fontSize=small;align=left</Options>
                        </Widget>
                        <Widget>
                          <WidgetId>dws_sec_sched</WidgetId>
                          <Name>Secondary Scheduler Nav: ${responses[6]}</Name>
                          <Type>Text</Type>
                          <Options>size=2;fontSize=small;align=left</Options>
                        </Widget>
                        <Widget>
                          <WidgetId>dws_sec_mics</WidgetId>
                          <Name>Secondary Microphones: ${secondaryMics}</Name>
                          <Type>Text</Type>
                          <Options>size=4;fontSize=small;align=left</Options>
                        </Widget>
                        <Widget>
                          <WidgetId>dws_wizard_codecs</WidgetId>
                          <Name>Next</Name>
                          <Type>Button</Type>
                          <Options>size=2</Options>
                        </Widget>
                      </Row>
                      <PageId>dws_wizard_codecs</PageId>
                      <Options>hideRowNames=1</Options>
                    </Page>
                    <Page>
                      <Name>Actions</Name>
                      <Row>
                        ...
                        <Widget>
                          <WidgetId>dws_wizard_setup</WidgetId>
                          <Name>Begin Setup</Name>
                          <Type>Button</Type>
                          <Options>size=2</Options>
                        </Widget>
                        <Widget>
                          <WidgetId>widget_79</WidgetId>
                          <Name>You can reset the wizard to re-enter any incorrect details.</Name>
                          <Type>Text</Type>
                          <Options>size=4;fontSize=small;align=center</Options>
                        </Widget>
                        <Widget>
                          <WidgetId>dws_wizard_restart</WidgetId>
                          <Name>Reset Wizard</Name>
                          <Type>Button</Type>
                          <Options>size=2</Options>
                        </Widget>
                      </Row>
                      <PageId>dws_wizard_actions</PageId>
                      <Options>hideRowNames=1</Options>
                    </Page>
                  </Panel>
                  </Extensions>`;
      ...
      console.log("DWS: Wizard Completed. Opening Confirmation Panel.");

      // OPEN THE CONFIRMATION PANEL AFTER QUICK PAUSE TO ALLOW FOR SAVE
      setTimeout(() => {
        xapi.Command.UserInterface.Extensions.Panel.Open({PanelId: 'dws_wizard_confirm' })
...
xapi.Event.UserInterface.Message.Prompt.Response.on(event => {
  ...
  if (event.FeedbackId == 'q7') {
      ...
      addedQ = (8 + Number(selectedOption));

      // STORE THE NUMBER OF MICS
      responses.push(selectedOption);   /// ADD NUMBER OF MICS LABEL FOR SEARCHING AND CONCAT TO SINGLE STRING ['FOC', 'FOC']
      currentQuestion++;
      askQuestion();
  }
  else if (event.FeedbackId == ('q' + addedQ.toString())) {
      const selectedOption = event.OptionId;
      ...
      const questionIndex = parseInt(event.FeedbackId.substring(1));
      const selectedOption = event.OptionId;
      const optionText = questions[questionIndex].options[`Option.${selectedOption}`];

      responses.push(optionText);
      currentQuestion++;
      askQuestion();
  }
});

// LISTEN FOR PANEL ICON PRESS
...
xapi.Event.UserInterface.Extensions.Widget.Action.on(event => {
  ...
  {
    xapi.Command.UserInterface.Extensions.Panel.Open( { PageId: 'dws_wizard_codecs', PanelId: 'dws_wizard_confirm' });
  }
  if( event.Type == 'released' && event.WidgetId == 'dws_wizard_codecs' )
  {
    xapi.Command.UserInterface.Extensions.Panel.Open( { PageId: 'dws_wizard_actions', PanelId: 'dws_wizard_confirm' });
  }
...
let wizPanel = `<Extensions><Panel>
    <PanelId>dws_wizard_start</PanelId>
    <Origin>local</Origin>
    <Location>HomeScreen</Location>
    <Icon>Custom</Icon>
    <Name>DWS Setup Wizard</Name>
...
// DRAW INITIAL WIZARD BUTTON
xapi.Command.UserInterface.Extensions.Panel.Save({PanelId: 'dws_wizard_start'}, wizPanel)
  .catch(e => console.log('Error saving panel: ' + e.message))
